...
void sys_thunk_6(item *const env, item *const ret)
{
/* TmLam (Param {paramName = "u_n", paramType = TpInt}) (TmTo (TmPrimBinOp PrimILe (TmVar "u_n") (TmInt 0)) "c_c_1" (TmIf (TmVar "c_c_1") (TmReturn (TmDouble 1.0)) (TmTo (TmPrimBinOp PrimISub (TmVar "u_n") (TmInt 1)) "c_a1_3" (TmTo (TmApp (TmForce (TmVar "u_pow")) (TmVar "u_x")) "c_f1_3" (TmTo (TmApp (TmForce (TmVar "c_f1_3")) (TmVar "c_a1_3")) "c_inp1_4" (TmPrimBinOp PrimDMul (TmVar "u_x") (TmVar "c_inp1_4"))))))) */
const item var_u_n = (global_stack.items[--global_stack.top]);
const item sys_arg0_0 = var_u_n;
...
void sys_thunk_7(item *const env, item *const ret)
{
/* TmLam (Param {paramName = "u_x", paramType = TpDouble}) (TmReturn (TmThunk (TmLam (Param {paramName = "u_n", paramType = TpInt}) (TmTo (TmPrimBinOp PrimILe (TmVar "u_n") (TmInt 0)) "c_c_1" (TmIf (TmVar "c_c_1") (TmReturn (TmDouble 1.0)) (TmTo (TmPrimBinOp PrimISub (TmVar "u_n") (TmInt 1)) "c_a1_3" (TmTo (TmApp (TmForce (TmVar "u_pow")) (TmVar "u_x")) "c_f1_3" (TmTo (TmApp (TmForce (TmVar "c_f1_3")) (TmVar "c_a1_3")) "c_inp1_4" (TmPrimBinOp PrimDMul (TmVar "u_x") (TmVar "c_inp1_4")))))))))) */
...
void sys_thunk_9(item *const env, item *const ret)
{
/* TmLet "c_r_5" (TmThunk (TmLam (Param {paramName = "u_x", paramType = TpDouble}) (TmReturn (TmThunk (TmLam (Param {paramName = "u_n", paramType = TpInt}) (TmTo (TmPrimBinOp PrimILe (TmVar "u_n") (TmInt 0)) "c_c_1" (TmIf (TmVar "c_c_1") (TmReturn (TmDouble 1.0)) (TmTo (TmPrimBinOp PrimISub (TmVar "u_n") (TmInt 1)) "c_a1_3" (TmTo (TmApp (TmForce (TmVar "u_pow")) (TmVar "u_x")) "c_f1_3" (TmTo (TmApp (TmForce (TmVar "c_f1_3")) (TmVar "c_a1_3")) "c_inp1_4" (TmPrimBinOp PrimDMul (TmVar "u_x") (TmVar "c_inp1_4")))))))))))) (TmForce (TmVar "c_r_5")) */
...
{
/* TmRec (Param {paramName = "u_pow", paramType = TpUp (TpDouble :->: TpDown (TpUp (TpInt :->: TpDown TpDouble)))}) (TmLet "c_r_5" (TmThunk (TmLam (Param {paramName = "u_x", paramType = TpDouble}) (TmReturn (TmThunk (TmLam (Param {paramName = "u_n", paramType = TpInt}) (TmTo (TmPrimBinOp PrimILe (TmVar "u_n") (TmInt 0)) "c_c_1" (TmIf (TmVar "c_c_1") (TmReturn (TmDouble 1.0)) (TmTo (TmPrimBinOp PrimISub (TmVar "u_n") (TmInt 1)) "c_a1_3" (TmTo (TmApp (TmForce (TmVar "u_pow")) (TmVar "u_x")) "c_f1_3" (TmTo (TmApp (TmForce (TmVar "c_f1_3")) (TmVar "c_a1_3")) "c_inp1_4" (TmPrimBinOp PrimDMul (TmVar "u_x") (TmVar "c_inp1_4")))))))))))) (TmForce (TmVar "c_r_5"))) */
...
{
/* TmReturn (TmThunk (TmRec (Param {paramName = "u_pow", paramType = TpUp (TpDouble :->: TpDown (TpUp (TpInt :->: TpDown TpDouble)))}) (TmLet "c_r_5" (TmThunk (TmLam (Param {paramName = "u_x", paramType = TpDouble}) (TmReturn (TmThunk (TmLam (Param {paramName = "u_n", paramType = TpInt}) (TmTo (TmPrimBinOp PrimILe (TmVar "u_n") (TmInt 0)) "c_c_1" (TmIf (TmVar "c_c_1") (TmReturn (TmDouble 1.0)) (TmTo (TmPrimBinOp PrimISub (TmVar "u_n") (TmInt 1)) "c_a1_3" (TmTo (TmApp (TmForce (TmVar "u_pow")) (TmVar "u_x")) "c_f1_3" (TmTo (TmApp (TmForce (TmVar "c_f1_3")) (TmVar "c_a1_3")) "c_inp1_4" (TmPrimBinOp PrimDMul (TmVar "u_x") (TmVar "c_inp1_4")))))))))))) (TmForce (TmVar "c_r_5"))))) */
...
void sys_thunk_18(item *const env, item *const ret)
{
/* TmLam (Param {paramName = "u_x", paramType = TpInt}) (TmTo (TmPrimBinOp PrimILe (TmVar "u_x") (TmInt 0)) "c_c_7" (TmIf (TmVar "c_c_7") (TmReturn (TmInt 1)) (TmTo (TmPrimBinOp PrimISub (TmVar "u_x") (TmInt 1)) "c_a0_9" (TmTo (TmApp (TmForce (TmVar "u_fact")) (TmVar "c_a0_9")) "c_inp1_10" (TmPrimBinOp PrimIMul (TmVar "u_x") (TmVar "c_inp1_10")))))) */
const item var_u_x = (global_stack.items[--global_stack.top]);
const item sys_arg0_13 = var_u_x;
...
{
const item sys_arg0_14 = var_u_x;
...
const item sys_arg0_16 = var_u_x;
...
void sys_thunk_20(item *const env, item *const ret)
{
/* TmLet "c_r_11" (TmThunk (TmLam (Param {paramName = "u_x", paramType = TpInt}) (TmTo (TmPrimBinOp PrimILe (TmVar "u_x") (TmInt 0)) "c_c_7" (TmIf (TmVar "c_c_7") (TmReturn (TmInt 1)) (TmTo (TmPrimBinOp PrimISub (TmVar "u_x") (TmInt 1)) "c_a0_9" (TmTo (TmApp (TmForce (TmVar "u_fact")) (TmVar "c_a0_9")) "c_inp1_10" (TmPrimBinOp PrimIMul (TmVar "u_x") (TmVar "c_inp1_10")))))))) (TmForce (TmVar "c_r_11")) */
...
{
/* TmRec (Param {paramName = "u_fact", paramType = TpUp (TpInt :->: TpDown TpInt)}) (TmLet "c_r_11" (TmThunk (TmLam (Param {paramName = "u_x", paramType = TpInt}) (TmTo (TmPrimBinOp PrimILe (TmVar "u_x") (TmInt 0)) "c_c_7" (TmIf (TmVar "c_c_7") (TmReturn (TmInt 1)) (TmTo (TmPrimBinOp PrimISub (TmVar "u_x") (TmInt 1)) "c_a0_9" (TmTo (TmApp (TmForce (TmVar "u_fact")) (TmVar "c_a0_9")) "c_inp1_10" (TmPrimBinOp PrimIMul (TmVar "u_x") (TmVar "c_inp1_10")))))))) (TmForce (TmVar "c_r_11"))) */
const item var_u_fact = {.thunk_item = {.code = sys_thunk_20, .env = (item *) malloc(1 * sizeof(item))}};
...
{
/* TmReturn (TmThunk (TmRec (Param {paramName = "u_fact", paramType = TpUp (TpInt :->: TpDown TpInt)}) (TmLet "c_r_11" (TmThunk (TmLam (Param {paramName = "u_x", paramType = TpInt}) (TmTo (TmPrimBinOp PrimILe (TmVar "u_x") (TmInt 0)) "c_c_7" (TmIf (TmVar "c_c_7") (TmReturn (TmInt 1)) (TmTo (TmPrimBinOp PrimISub (TmVar "u_x") (TmInt 1)) "c_a0_9" (TmTo (TmApp (TmForce (TmVar "u_fact")) (TmVar "c_a0_9")) "c_inp1_10" (TmPrimBinOp PrimIMul (TmVar "u_x") (TmVar "c_inp1_10")))))))) (TmForce (TmVar "c_r_11"))))) */
...
void sys_thunk_29(item *const env, item *const ret)
{
/* TmLam (Param {paramName = "u_n", paramType = TpInt}) (TmTo (TmApp (TmForce (TmGlobal "u_pow")) (TmVar "u_x")) "c_f1_12" (TmTo (TmApp (TmForce (TmVar "c_f1_12")) (TmVar "u_n")) "c_inp0_15" (TmTo (TmApp (TmForce (TmGlobal "u_fact")) (TmVar "u_n")) "c_inp_14" (TmTo (TmPrimUnOp PrimIToD (TmVar "c_inp_14")) "c_inp1_15" (TmPrimBinOp PrimDDiv (TmVar "c_inp0_15") (TmVar "c_inp1_15")))))) */
const item var_u_n = (global_stack.items[--global_stack.top]);
(global_stack.items[global_stack.top++]) = (env[0]);
const item sys_t_24 = top_u_pow;
...
(global_stack.items[global_stack.top++]) = var_u_n;
const item sys_t_26 = top_u_fact;
...
{
/* TmLam (Param {paramName = "u_x", paramType = TpDouble}) (TmReturn (TmThunk (TmLam (Param {paramName = "u_n", paramType = TpInt}) (TmTo (TmApp (TmForce (TmGlobal "u_pow")) (TmVar "u_x")) "c_f1_12" (TmTo (TmApp (TmForce (TmVar "c_f1_12")) (TmVar "u_n")) "c_inp0_15" (TmTo (TmApp (TmForce (TmGlobal "u_fact")) (TmVar "u_n")) "c_inp_14" (TmTo (TmPrimUnOp PrimIToD (TmVar "c_inp_14")) "c_inp1_15" (TmPrimBinOp PrimDDiv (TmVar "c_inp0_15") (TmVar "c_inp1_15"))))))))) */
const item var_u_x = (global_stack.items[--global_stack.top]);
...
{
/* TmReturn (TmThunk (TmLam (Param {paramName = "u_x", paramType = TpDouble}) (TmReturn (TmThunk (TmLam (Param {paramName = "u_n", paramType = TpInt}) (TmTo (TmApp (TmForce (TmGlobal "u_pow")) (TmVar "u_x")) "c_f1_12" (TmTo (TmApp (TmForce (TmVar "c_f1_12")) (TmVar "u_n")) "c_inp0_15" (TmTo (TmApp (TmForce (TmGlobal "u_fact")) (TmVar "u_n")) "c_inp_14" (TmTo (TmPrimUnOp PrimIToD (TmVar "c_inp_14")) "c_inp1_15" (TmPrimBinOp PrimDDiv (TmVar "c_inp0_15") (TmVar "c_inp1_15"))))))))))) */
...
{
/* TmLam (Param {paramName = "u_x", paramType = TpDouble}) (TmTo (TmApp (TmForce (TmGlobal "u_sinEntry")) (TmVar "u_x")) "c_f1_16" (TmTo (TmApp (TmForce (TmVar "c_f1_16")) (TmInt 1)) "c_inp0_18" (TmTo (TmApp (TmForce (TmGlobal "u_sinEntry")) (TmVar "u_x")) "c_f1_17" (TmTo (TmApp (TmForce (TmVar "c_f1_17")) (TmInt 3)) "c_inp1_18" (TmTo (TmPrimBinOp PrimDSub (TmVar "c_inp0_18") (TmVar "c_inp1_18")) "c_inp0_20" (TmTo (TmApp (TmForce (TmGlobal "u_sinEntry")) (TmVar "u_x")) "c_f1_19" (TmTo (TmApp (TmForce (TmVar "c_f1_19")) (TmInt 5)) "c_inp1_20" (TmTo (TmPrimBinOp PrimDAdd (TmVar "c_inp0_20") (TmVar "c_inp1_20")) "c_inp0_22" (TmTo (TmApp (TmForce (TmGlobal "u_sinEntry")) (TmVar "u_x")) "c_f1_21" (TmTo (TmApp (TmForce (TmVar "c_f1_21")) (TmInt 7)) "c_inp1_22" (TmTo (TmPrimBinOp PrimDSub (TmVar "c_inp0_22") (TmVar "c_inp1_22")) "c_inp0_24" (TmTo (TmApp (TmForce (TmGlobal "u_sinEntry")) (TmVar "u_x")) "c_f1_23" (TmTo (TmApp (TmForce (TmVar "c_f1_23")) (TmInt 9)) "c_inp1_24" (TmTo (TmPrimBinOp PrimDAdd (TmVar "c_inp0_24") (TmVar "c_inp1_24")) "c_inp0_26" (TmTo (TmApp (TmForce (TmGlobal "u_sinEntry")) (TmVar "u_x")) "c_f1_25" (TmTo (TmApp (TmForce (TmVar "c_f1_25")) (TmInt 11)) "c_inp1_26" (TmTo (TmPrimBinOp PrimDSub (TmVar "c_inp0_26") (TmVar "c_inp1_26")) "c_inp0_28" (TmTo (TmApp (TmForce (TmGlobal "u_sinEntry")) (TmVar "u_x")) "c_f1_27" (TmTo (TmApp (TmForce (TmVar "c_f1_27")) (TmInt 13)) "c_inp1_28" (TmTo (TmPrimBinOp PrimDAdd (TmVar "c_inp0_28") (TmVar "c_inp1_28")) "c_inp0_30" (TmTo (TmApp (TmForce (TmGlobal "u_sinEntry")) (TmVar "u_x")) "c_f1_29" (TmTo (TmApp (TmForce (TmVar "c_f1_29")) (TmInt 15)) "c_inp1_30" (TmPrimBinOp PrimDSub (TmVar "c_inp0_30") (TmVar "c_inp1_30")))))))))))))))))))))))) */
const item var_u_x = (global_stack.items[--global_stack.top]);
(global_stack.items[global_stack.top++]) = var_u_x;
const item sys_t_33 = top_u_sinEntry;
...
(global_stack.items[global_stack.top++]) = var_u_x;
const item sys_t_35 = top_u_sinEntry;
...
(global_stack.items[global_stack.top++]) = var_u_x;
const item sys_t_38 = top_u_sinEntry;
...
(global_stack.items[global_stack.top++]) = var_u_x;
const item sys_t_41 = top_u_sinEntry;
...
(global_stack.items[global_stack.top++]) = var_u_x;
const item sys_t_44 = top_u_sinEntry;
...
(global_stack.items[global_stack.top++]) = var_u_x;
const item sys_t_47 = top_u_sinEntry;
...
(global_stack.items[global_stack.top++]) = var_u_x;
const item sys_t_50 = top_u_sinEntry;
...
(global_stack.items[global_stack.top++]) = var_u_x;
const item sys_t_53 = top_u_sinEntry;
...
{
/* TmReturn (TmThunk (TmLam (Param {paramName = "u_x", paramType = TpDouble}) (TmTo (TmApp (TmForce (TmGlobal "u_sinEntry")) (TmVar "u_x")) "c_f1_16" (TmTo (TmApp (TmForce (TmVar "c_f1_16")) (TmInt 1)) "c_inp0_18" (TmTo (TmApp (TmForce (TmGlobal "u_sinEntry")) (TmVar "u_x")) "c_f1_17" (TmTo (TmApp (TmForce (TmVar "c_f1_17")) (TmInt 3)) "c_inp1_18" (TmTo (TmPrimBinOp PrimDSub (TmVar "c_inp0_18") (TmVar "c_inp1_18")) "c_inp0_20" (TmTo (TmApp (TmForce (TmGlobal "u_sinEntry")) (TmVar "u_x")) "c_f1_19" (TmTo (TmApp (TmForce (TmVar "c_f1_19")) (TmInt 5)) "c_inp1_20" (TmTo (TmPrimBinOp PrimDAdd (TmVar "c_inp0_20") (TmVar "c_inp1_20")) "c_inp0_22" (TmTo (TmApp (TmForce (TmGlobal "u_sinEntry")) (TmVar "u_x")) "c_f1_21" (TmTo (TmApp (TmForce (TmVar "c_f1_21")) (TmInt 7)) "c_inp1_22" (TmTo (TmPrimBinOp PrimDSub (TmVar "c_inp0_22") (TmVar "c_inp1_22")) "c_inp0_24" (TmTo (TmApp (TmForce (TmGlobal "u_sinEntry")) (TmVar "u_x")) "c_f1_23" (TmTo (TmApp (TmForce (TmVar "c_f1_23")) (TmInt 9)) "c_inp1_24" (TmTo (TmPrimBinOp PrimDAdd (TmVar "c_inp0_24") (TmVar "c_inp1_24")) "c_inp0_26" (TmTo (TmApp (TmForce (TmGlobal "u_sinEntry")) (TmVar "u_x")) "c_f1_25" (TmTo (TmApp (TmForce (TmVar "c_f1_25")) (TmInt 11)) "c_inp1_26" (TmTo (TmPrimBinOp PrimDSub (TmVar "c_inp0_26") (TmVar "c_inp1_26")) "c_inp0_28" (TmTo (TmApp (TmForce (TmGlobal "u_sinEntry")) (TmVar "u_x")) "c_f1_27" (TmTo (TmApp (TmForce (TmVar "c_f1_27")) (TmInt 13)) "c_inp1_28" (TmTo (TmPrimBinOp PrimDAdd (TmVar "c_inp0_28") (TmVar "c_inp1_28")) "c_inp0_30" (TmTo (TmApp (TmForce (TmGlobal "u_sinEntry")) (TmVar "u_x")) "c_f1_29" (TmTo (TmApp (TmForce (TmVar "c_f1_29")) (TmInt 15)) "c_inp1_30" (TmPrimBinOp PrimDSub (TmVar "c_inp0_30") (TmVar "c_inp1_30")))))))))))))))))))))))))) */
...
{
/* TmTo (TmApp (TmForce (TmGlobal "u_sin")) (TmDouble 0.5)) "c_v_32" (TmPrintDouble (TmVar "c_v_32") (TmReturn (TmInt 0))) */
(global_stack.items[global_stack.top++]).double_item = 0.5;
const item sys_t_59 = top_u_sin;
