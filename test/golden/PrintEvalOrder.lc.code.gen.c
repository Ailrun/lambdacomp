...
{
/* TmTo (TmPrintInt (TmConst (TmCInt 7)) (TmReturn (TmConst (TmCInt 3)))) "c_a0_3" (TmTo (TmPrintInt (TmConst (TmCInt 2)) (TmReturn (TmVar "c_a0_3"))) "c_v_4" (TmPrintInt (TmVar "c_v_4") (TmReturn (TmConst (TmCInt 0))))) */
