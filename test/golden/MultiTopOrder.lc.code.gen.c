...
{
/* TmPrintInt (TmConst (TmCInt 5)) (TmReturn (TmThunk (TmLam (BTyped (Param {paramName = "e_x", paramType = TpConst TpCInt}) (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmConst (TmCInt 3))))))) */
...
{
/* TmLam (BTyped (Param {paramName = "e_x", paramType = TpConst TpCInt}) (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmConst (TmCInt 1)))) */
const item var_e_x = (global_stack.items[--global_stack.top]);
...
{
/* TmPrintInt (TmConst (TmCInt 4)) (TmReturn (TmThunk (TmLam (BTyped (Param {paramName = "e_x", paramType = TpConst TpCInt}) (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmConst (TmCInt 1))))))) */
