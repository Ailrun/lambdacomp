...
{
/* TmLam (Param {paramName = "e_x", paramType = TpInt}) (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmInt 1)) */
const item var_e_x = (global_stack.items[--global_stack.top]);
...
{
/* TmPrintInt (TmInt 4) (TmReturn (TmThunk (TmLam (Param {paramName = "e_x", paramType = TpInt}) (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmInt 1))))) */
