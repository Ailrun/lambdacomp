...
{
/* TmTo (TmPrintInt (TmConst (TmCInt 5)) (TmReturn (TmThunk (TmLam (BTyped (Param {paramName = "e_x", paramType = TpConst TpCInt}) (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmConst (TmCInt 3)))))))) (BUntyped "aa_0_0_temp" (TmForce (TmVar "aa_0_0_temp"))) */
...
{
/* TmReturn (TmThunk (TmTo (TmPrintInt (TmConst (TmCInt 5)) (TmReturn (TmThunk (TmLam (BTyped (Param {paramName = "e_x", paramType = TpConst TpCInt}) (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmConst (TmCInt 3)))))))) (BUntyped "aa_0_0_temp" (TmForce (TmVar "aa_0_0_temp"))))) */
...
{
/* TmTo (TmApp (TmForce (TmGlobal "e_f")) (TmConst (TmCInt 3))) (BUntyped "c_v_3" (TmPrintInt (TmVar "c_v_3") (TmReturn (TmConst (TmCInt 0))))) */
