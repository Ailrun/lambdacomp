...
{
/* TmPrintInt (TmConst (TmCInt 5)) (TmLam (BTyped (Param {paramName = "e_x", paramType = TpConst TpCInt}) (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmConst (TmCInt 3))))) */
const item sys_msg_1 = {.int_item = 5};
printf("%d\n", sys_msg_1.int_item);
...
{
/* TmReturn (TmThunk (TmPrintInt (TmConst (TmCInt 5)) (TmLam (BTyped (Param {paramName = "e_x", paramType = TpConst TpCInt}) (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmConst (TmCInt 3))))))) */
