...
{
/* TmTo (TmPrintInt (TmConst (TmCInt 5)) (TmReturn (TmThunk (TmLam (Param {paramName = "e_x", paramType = TpConst TpCInt}) (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmConst (TmCInt 3))))))) "aa_0_0_temp" (TmForce (TmVar "aa_0_0_temp")) */
...
{
/* TmReturn (TmThunk (TmTo (TmPrintInt (TmConst (TmCInt 5)) (TmReturn (TmThunk (TmLam (Param {paramName = "e_x", paramType = TpConst TpCInt}) (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmConst (TmCInt 3))))))) "aa_0_0_temp" (TmForce (TmVar "aa_0_0_temp")))) */
