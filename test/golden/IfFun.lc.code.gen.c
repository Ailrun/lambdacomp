...
{
/* TmLam (Param {paramName = "e_x", paramType = TpConst TpCInt}) (TmPrimBinOp PrimIMul (TmVar "e_x") (TmVar "e_x")) */
const item var_e_x = (global_stack.items[--global_stack.top]);
...
{
/* TmLam (Param {paramName = "e_c", paramType = TpConst TpCBool}) (TmTo (TmIf (TmVar "e_c") (TmReturn (TmThunk (TmLam (Param {paramName = "e_x", paramType = TpConst TpCInt}) (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmConst (TmCInt 3)))))) (TmReturn (TmThunk (TmLam (Param {paramName = "e_x", paramType = TpConst TpCInt}) (TmPrimBinOp PrimIMul (TmVar "e_x") (TmVar "e_x")))))) "c_f_3" (TmApp (TmForce (TmVar "c_f_3")) (TmConst (TmCInt 3)))) */
...
{
/* TmReturn (TmThunk (TmLam (Param {paramName = "e_c", paramType = TpConst TpCBool}) (TmTo (TmIf (TmVar "e_c") (TmReturn (TmThunk (TmLam (Param {paramName = "e_x", paramType = TpConst TpCInt}) (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmConst (TmCInt 3)))))) (TmReturn (TmThunk (TmLam (Param {paramName = "e_x", paramType = TpConst TpCInt}) (TmPrimBinOp PrimIMul (TmVar "e_x") (TmVar "e_x")))))) "c_f_3" (TmApp (TmForce (TmVar "c_f_3")) (TmConst (TmCInt 3)))))) */
...
{
/* TmTo (TmApp (TmForce (TmGlobal "e_f")) (TmConst TmCTrue)) "c_v_5" (TmTo (TmApp (TmForce (TmGlobal "e_f")) (TmConst TmCFalse)) "c_v_7" (TmPrintInt (TmVar "c_v_5") (TmPrintInt (TmVar "c_v_7") (TmReturn (TmConst (TmCInt 0)))))) */
