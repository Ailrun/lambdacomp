...
{
/* TmTo (TmApp (TmForce (TmGlobal "e_f")) (TmConst (TmCInt 3))) "c_a_9" (TmTo (TmApp (TmForce (TmVar "c_a_9")) (TmConst (TmCInt 2))) "c_f_4" (TmTo (TmApp (TmForce (TmVar "c_f_4")) (TmConst (TmCInt 5))) "c_v_5" (TmTo (TmApp (TmForce (TmVar "c_a_9")) (TmConst (TmCInt 4))) "c_f_7" (TmTo (TmApp (TmForce (TmVar "c_f_7")) (TmConst (TmCInt 1))) "c_v_8" (TmPrintInt (TmVar "c_v_5") (TmPrintInt (TmVar "c_v_8") (TmReturn (TmConst (TmCInt 0))))))))) */
