...
void sys_thunk_2(item *const env, item *const ret)
{
/* TmTo (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmVar "e_y")) (BUntyped "c_inp0_1" (TmLam (BTyped (Param {paramName = "e_z", paramType = TpConst TpCInt}) (TmPrimBinOp PrimIAdd (TmVar "c_inp0_1") (TmVar "e_z"))))) */
...
void sys_thunk_3(item *const env, item *const ret)
{
/* TmLam (BTyped (Param {paramName = "e_y", paramType = TpConst TpCInt}) (TmReturn (TmThunk (TmTo (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmVar "e_y")) (BUntyped "c_inp0_1" (TmLam (BTyped (Param {paramName = "e_z", paramType = TpConst TpCInt}) (TmPrimBinOp PrimIAdd (TmVar "c_inp0_1") (TmVar "e_z"))))))))) */
...
{
/* TmLam (BTyped (Param {paramName = "e_x", paramType = TpConst TpCInt}) (TmReturn (TmThunk (TmLam (BTyped (Param {paramName = "e_y", paramType = TpConst TpCInt}) (TmReturn (TmThunk (TmTo (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmVar "e_y")) (BUntyped "c_inp0_1" (TmLam (BTyped (Param {paramName = "e_z", paramType = TpConst TpCInt}) (TmPrimBinOp PrimIAdd (TmVar "c_inp0_1") (TmVar "e_z"))))))))))))) */
...
{
/* TmTo (TmApp (TmForce (TmGlobal "e_f")) (TmConst (TmCInt 3))) (BUntyped "c_a_9" (TmTo (TmApp (TmForce (TmVar "c_a_9")) (TmConst (TmCInt 2))) (BUntyped "c_f_4" (TmTo (TmApp (TmForce (TmVar "c_f_4")) (TmConst (TmCInt 5))) (BUntyped "c_v_5" (TmTo (TmApp (TmForce (TmVar "c_a_9")) (TmConst (TmCInt 4))) (BUntyped "c_f_7" (TmTo (TmApp (TmForce (TmVar "c_f_7")) (TmConst (TmCInt 1))) (BUntyped "c_v_8" (TmPrintInt (TmVar "c_v_5") (TmPrintInt (TmVar "c_v_8") (TmReturn (TmConst (TmCInt 0)))))))))))))) */
