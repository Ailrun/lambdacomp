...
void sys_thunk_6(item *const env, item *const ret)
{
/* TmLam (Param {paramName = "aa_0_0", paramType = TpInt}) (TmTo (TmPrimBinOp PrimIGt (TmVar "aa_0_0") (TmInt 0)) "c_c_3" (TmLam (Param {paramName = "aa_1_0", paramType = TpInt}) (TmPrintInt (TmVar "aa_1_0") (TmPrintInt (TmInt 2) (TmIf (TmVar "c_c_3") (TmTo (TmPrimBinOp PrimISub (TmVar "aa_0_0") (TmInt 1)) "c_a0_5" (TmApp (TmApp (TmForce (TmVar "e_recF")) (TmVar "c_a0_5")) (TmVar "aa_1_0"))) (TmReturn (TmInt 0))))))) */
...
const item sys_msg_5 = var_aa_1_0;
printf("%d\n", sys_msg_5.int_item);
...
{
/* TmLam (Param {paramName = "aa_0_1", paramType = TpInt}) (TmLam (Param {paramName = "aa_1_1", paramType = TpInt}) (TmApp (TmApp (TmRec (Param {paramName = "e_recF", paramType = TpUp (TpInt :->: (TpInt :->: TpDown TpInt))}) (TmLam (Param {paramName = "aa_0_0", paramType = TpInt}) (TmTo (TmPrimBinOp PrimIGt (TmVar "aa_0_0") (TmInt 0)) "c_c_3" (TmLam (Param {paramName = "aa_1_0", paramType = TpInt}) (TmPrintInt (TmVar "aa_1_0") (TmPrintInt (TmInt 2) (TmIf (TmVar "c_c_3") (TmTo (TmPrimBinOp PrimISub (TmVar "aa_0_0") (TmInt 1)) "c_a0_5" (TmApp (TmApp (TmForce (TmVar "e_recF")) (TmVar "c_a0_5")) (TmVar "aa_1_0"))) (TmReturn (TmInt 0))))))))) (TmVar "aa_0_1")) (TmVar "aa_1_1"))) */
...
{
/* TmApp (TmApp (TmForce (TmGlobal "e_recF")) (TmInt 1000000)) (TmInt 3) */
