...
void sys_thunk_7(item *const env, item *const ret)
{
/* TmLam (Param {paramName = "e_x", paramType = TpInt}) (TmTo (TmPrimBinOp PrimIGt (TmVar "e_n") (TmInt 0)) "c_c_3" (TmPrintInt (TmVar "e_x") (TmPrintInt (TmInt 2) (TmIf (TmVar "c_c_3") (TmTo (TmPrimBinOp PrimISub (TmVar "e_n") (TmInt 1)) "c_a0_5" (TmTo (TmApp (TmForce (TmVar "e_recF")) (TmVar "c_a0_5")) "c_f1_5" (TmApp (TmForce (TmVar "c_f1_5")) (TmVar "e_x")))) (TmReturn (TmInt 0)))))) */
...
void sys_thunk_10(item *const env, item *const ret)
{
/* TmLet "c_r_6" (TmThunk (TmLam (Param {paramName = "e_n", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "e_x", paramType = TpInt}) (TmTo (TmPrimBinOp PrimIGt (TmVar "e_n") (TmInt 0)) "c_c_3" (TmPrintInt (TmVar "e_x") (TmPrintInt (TmInt 2) (TmIf (TmVar "c_c_3") (TmTo (TmPrimBinOp PrimISub (TmVar "e_n") (TmInt 1)) "c_a0_5" (TmTo (TmApp (TmForce (TmVar "e_recF")) (TmVar "c_a0_5")) "c_f1_5" (TmApp (TmForce (TmVar "c_f1_5")) (TmVar "e_x")))) (TmReturn (TmInt 0))))))))))) (TmForce (TmVar "c_r_6")) */
...
{
/* TmRec (Param {paramName = "e_recF", paramType = TpUp (TpInt :->: TpDown (TpUp (TpInt :->: TpDown TpInt)))}) (TmLet "c_r_6" (TmThunk (TmLam (Param {paramName = "e_n", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "e_x", paramType = TpInt}) (TmTo (TmPrimBinOp PrimIGt (TmVar "e_n") (TmInt 0)) "c_c_3" (TmPrintInt (TmVar "e_x") (TmPrintInt (TmInt 2) (TmIf (TmVar "c_c_3") (TmTo (TmPrimBinOp PrimISub (TmVar "e_n") (TmInt 1)) "c_a0_5" (TmTo (TmApp (TmForce (TmVar "e_recF")) (TmVar "c_a0_5")) "c_f1_5" (TmApp (TmForce (TmVar "c_f1_5")) (TmVar "e_x")))) (TmReturn (TmInt 0))))))))))) (TmForce (TmVar "c_r_6"))) */
const item var_e_recF = {.thunk_item = {.code = sys_thunk_10, .env = (item *) malloc(1 * sizeof(item))}};
...
{
/* TmReturn (TmThunk (TmRec (Param {paramName = "e_recF", paramType = TpUp (TpInt :->: TpDown (TpUp (TpInt :->: TpDown TpInt)))}) (TmLet "c_r_6" (TmThunk (TmLam (Param {paramName = "e_n", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "e_x", paramType = TpInt}) (TmTo (TmPrimBinOp PrimIGt (TmVar "e_n") (TmInt 0)) "c_c_3" (TmPrintInt (TmVar "e_x") (TmPrintInt (TmInt 2) (TmIf (TmVar "c_c_3") (TmTo (TmPrimBinOp PrimISub (TmVar "e_n") (TmInt 1)) "c_a0_5" (TmTo (TmApp (TmForce (TmVar "e_recF")) (TmVar "c_a0_5")) "c_f1_5" (TmApp (TmForce (TmVar "c_f1_5")) (TmVar "e_x")))) (TmReturn (TmInt 0))))))))))) (TmForce (TmVar "c_r_6"))))) */
...
{
/* TmTo (TmApp (TmForce (TmGlobal "e_recF")) (TmInt 1000000)) "c_f1_7" (TmApp (TmForce (TmVar "c_f1_7")) (TmInt 3)) */
(global_stack.items[global_stack.top++]).int_item = 1000000;
const item sys_t_14 = top_e_recF;
