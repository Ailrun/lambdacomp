...
void sys_thunk_10(item *const env, item *const ret)
{
/* TmLet "c_f0_5" (TmThunk (TmLam (Param {paramName = "aa_0_0", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "aa_1_0", paramType = TpInt}) (TmApp (TmApp (TmForce (TmVar "e_recF")) (TmVar "aa_0_0")) (TmVar "aa_1_0"))))))) (TmTo (TmPrimBinOp PrimIGt (TmVar "e_n") (TmInt 0)) "c_c_3" (TmLam (Param {paramName = "e_x", paramType = TpInt}) (TmPrintInt (TmVar "e_x") (TmPrintInt (TmInt 2) (TmIf (TmVar "c_c_3") (TmTo (TmPrimBinOp PrimISub (TmVar "e_n") (TmInt 1)) "c_a0_5" (TmTo (TmApp (TmForce (TmVar "c_f0_5")) (TmVar "c_a0_5")) "c_f1_5" (TmApp (TmForce (TmVar "c_f1_5")) (TmVar "e_x")))) (TmReturn (TmInt 0))))))) */
...
void sys_thunk_11(item *const env, item *const ret)
{
/* TmLam (Param {paramName = "e_n", paramType = TpInt}) (TmReturn (TmThunk (TmLet "c_f0_5" (TmThunk (TmLam (Param {paramName = "aa_0_0", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "aa_1_0", paramType = TpInt}) (TmApp (TmApp (TmForce (TmVar "e_recF")) (TmVar "aa_0_0")) (TmVar "aa_1_0"))))))) (TmTo (TmPrimBinOp PrimIGt (TmVar "e_n") (TmInt 0)) "c_c_3" (TmLam (Param {paramName = "e_x", paramType = TpInt}) (TmPrintInt (TmVar "e_x") (TmPrintInt (TmInt 2) (TmIf (TmVar "c_c_3") (TmTo (TmPrimBinOp PrimISub (TmVar "e_n") (TmInt 1)) "c_a0_5" (TmTo (TmApp (TmForce (TmVar "c_f0_5")) (TmVar "c_a0_5")) "c_f1_5" (TmApp (TmForce (TmVar "c_f1_5")) (TmVar "e_x")))) (TmReturn (TmInt 0)))))))))) */
