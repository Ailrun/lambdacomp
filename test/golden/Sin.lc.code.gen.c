...
void sys_thunk_14(item *const env, item *const ret)
{
/* TmLam (Param {paramName = "e_x", paramType = TpConst TpCInt}) (TmTo (TmPrimBinOp PrimILe (TmVar "e_x") (TmConst (TmCInt 0))) "c_c_8" (TmIf (TmVar "c_c_8") (TmReturn (TmConst (TmCInt 1))) (TmTo (TmPrimBinOp PrimISub (TmVar "e_x") (TmConst (TmCInt 1))) "c_a_10" (TmTo (TmApp (TmForce (TmVar "e_fact")) (TmVar "c_a_10")) "c_inp1_11" (TmPrimBinOp PrimIMul (TmVar "e_x") (TmVar "c_inp1_11")))))) */
...
{
/* TmLam (Param {paramName = "aa_0_1", paramType = TpConst TpCDouble}) (TmLam (Param {paramName = "e_n", paramType = TpConst TpCInt}) (TmTo (TmApp (TmApp (TmForce (TmGlobal "e_pow")) (TmVar "aa_0_1")) (TmVar "e_n")) "c_inp0_17" (TmTo (TmApp (TmForce (TmGlobal "e_fact")) (TmVar "e_n")) "c_inp_16" (TmTo (TmPrimUnOp PrimIToD (TmVar "c_inp_16")) "c_inp1_17" (TmPrimBinOp PrimDDiv (TmVar "c_inp0_17") (TmVar "c_inp1_17")))))) */
...
{
/* TmLam (Param {paramName = "e_x", paramType = TpConst TpCDouble}) (TmTo (TmApp (TmApp (TmForce (TmGlobal "e_sinEntry")) (TmVar "e_x")) (TmConst (TmCInt 1))) "c_inp0_22" (TmTo (TmApp (TmApp (TmForce (TmGlobal "e_sinEntry")) (TmVar "e_x")) (TmConst (TmCInt 3))) "c_inp1_22" (TmTo (TmPrimBinOp PrimDSub (TmVar "c_inp0_22") (TmVar "c_inp1_22")) "c_inp0_25" (TmTo (TmApp (TmApp (TmForce (TmGlobal "e_sinEntry")) (TmVar "e_x")) (TmConst (TmCInt 5))) "c_inp1_25" (TmTo (TmPrimBinOp PrimDAdd (TmVar "c_inp0_25") (TmVar "c_inp1_25")) "c_inp0_28" (TmTo (TmApp (TmApp (TmForce (TmGlobal "e_sinEntry")) (TmVar "e_x")) (TmConst (TmCInt 7))) "c_inp1_28" (TmTo (TmPrimBinOp PrimDSub (TmVar "c_inp0_28") (TmVar "c_inp1_28")) "c_inp0_31" (TmTo (TmApp (TmApp (TmForce (TmGlobal "e_sinEntry")) (TmVar "e_x")) (TmConst (TmCInt 9))) "c_inp1_31" (TmTo (TmPrimBinOp PrimDAdd (TmVar "c_inp0_31") (TmVar "c_inp1_31")) "c_inp0_34" (TmTo (TmApp (TmApp (TmForce (TmGlobal "e_sinEntry")) (TmVar "e_x")) (TmConst (TmCInt 11))) "c_inp1_34" (TmTo (TmPrimBinOp PrimDSub (TmVar "c_inp0_34") (TmVar "c_inp1_34")) "c_inp0_37" (TmTo (TmApp (TmApp (TmForce (TmGlobal "e_sinEntry")) (TmVar "e_x")) (TmConst (TmCInt 13))) "c_inp1_37" (TmTo (TmPrimBinOp PrimDAdd (TmVar "c_inp0_37") (TmVar "c_inp1_37")) "c_inp0_40" (TmTo (TmApp (TmApp (TmForce (TmGlobal "e_sinEntry")) (TmVar "e_x")) (TmConst (TmCInt 15))) "c_inp1_40" (TmPrimBinOp PrimDSub (TmVar "c_inp0_40") (TmVar "c_inp1_40")))))))))))))))) */
const item var_e_x = (global_stack.items[--global_stack.top]);
...
{
/* TmTo (TmApp (TmForce (TmGlobal "e_sin")) (TmConst (TmCDouble 0.5))) "c_v_42" (TmPrintDouble (TmVar "c_v_42") (TmReturn (TmConst (TmCInt 0)))) */
