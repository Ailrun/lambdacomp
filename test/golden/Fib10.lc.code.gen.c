...
void sys_thunk_10(item *const env, item *const ret)
{
/* TmTo (TmPrimBinOp PrimILt (TmVar "e_n") (TmVar "e_l")) "c_c_1" (TmLam (Param {paramName = "e_y", paramType = TpInt}) (TmIf (TmVar "c_c_1") (TmReturn (TmInt 0)) (TmTo (TmPrimBinOp PrimIAdd (TmVar "e_l") (TmInt 1)) "c_a1_6" (TmTo (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmVar "e_y")) "c_a3_6" (TmTo (TmApp (TmForce (TmVar "e_recFib")) (TmVar "e_n")) "c_f1_6" (TmTo (TmApp (TmForce (TmVar "c_f1_6")) (TmVar "c_a1_6")) "c_f2_6" (TmTo (TmApp (TmForce (TmVar "c_f2_6")) (TmVar "e_y")) "c_f3_6" (TmPrintInt (TmVar "e_l") (TmPrintInt (TmVar "e_x") (TmApp (TmForce (TmVar "c_f3_6")) (TmVar "c_a3_6"))))))))))) */
...
void sys_thunk_11(item *const env, item *const ret)
{
/* TmLam (Param {paramName = "e_x", paramType = TpInt}) (TmReturn (TmThunk (TmTo (TmPrimBinOp PrimILt (TmVar "e_n") (TmVar "e_l")) "c_c_1" (TmLam (Param {paramName = "e_y", paramType = TpInt}) (TmIf (TmVar "c_c_1") (TmReturn (TmInt 0)) (TmTo (TmPrimBinOp PrimIAdd (TmVar "e_l") (TmInt 1)) "c_a1_6" (TmTo (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmVar "e_y")) "c_a3_6" (TmTo (TmApp (TmForce (TmVar "e_recFib")) (TmVar "e_n")) "c_f1_6" (TmTo (TmApp (TmForce (TmVar "c_f1_6")) (TmVar "c_a1_6")) "c_f2_6" (TmTo (TmApp (TmForce (TmVar "c_f2_6")) (TmVar "e_y")) "c_f3_6" (TmPrintInt (TmVar "e_l") (TmPrintInt (TmVar "e_x") (TmApp (TmForce (TmVar "c_f3_6")) (TmVar "c_a3_6")))))))))))))) */
...
{
/* TmRec (Param {paramName = "e_recFib", paramType = TpUp (TpInt :->: TpDown (TpUp (TpInt :->: TpDown (TpUp (TpInt :->: TpDown (TpUp (TpInt :->: TpDown TpInt)))))))}) (TmLet "c_r_7" (TmThunk (TmLam (Param {paramName = "e_n", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "e_l", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "e_x", paramType = TpInt}) (TmReturn (TmThunk (TmTo (TmPrimBinOp PrimILt (TmVar "e_n") (TmVar "e_l")) "c_c_1" (TmLam (Param {paramName = "e_y", paramType = TpInt}) (TmIf (TmVar "c_c_1") (TmReturn (TmInt 0)) (TmTo (TmPrimBinOp PrimIAdd (TmVar "e_l") (TmInt 1)) "c_a1_6" (TmTo (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmVar "e_y")) "c_a3_6" (TmTo (TmApp (TmForce (TmVar "e_recFib")) (TmVar "e_n")) "c_f1_6" (TmTo (TmApp (TmForce (TmVar "c_f1_6")) (TmVar "c_a1_6")) "c_f2_6" (TmTo (TmApp (TmForce (TmVar "c_f2_6")) (TmVar "e_y")) "c_f3_6" (TmPrintInt (TmVar "e_l") (TmPrintInt (TmVar "e_x") (TmApp (TmForce (TmVar "c_f3_6")) (TmVar "c_a3_6")))))))))))))))))))))) (TmForce (TmVar "c_r_7"))) */
const item var_e_recFib = {.thunk_item = {.code = sys_thunk_15, .env = (item *) malloc(1 * sizeof(item))}};
...
{
/* TmReturn (TmThunk (TmRec (Param {paramName = "e_recFib", paramType = TpUp (TpInt :->: TpDown (TpUp (TpInt :->: TpDown (TpUp (TpInt :->: TpDown (TpUp (TpInt :->: TpDown TpInt)))))))}) (TmLet "c_r_7" (TmThunk (TmLam (Param {paramName = "e_n", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "e_l", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "e_x", paramType = TpInt}) (TmReturn (TmThunk (TmTo (TmPrimBinOp PrimILt (TmVar "e_n") (TmVar "e_l")) "c_c_1" (TmLam (Param {paramName = "e_y", paramType = TpInt}) (TmIf (TmVar "c_c_1") (TmReturn (TmInt 0)) (TmTo (TmPrimBinOp PrimIAdd (TmVar "e_l") (TmInt 1)) "c_a1_6" (TmTo (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmVar "e_y")) "c_a3_6" (TmTo (TmApp (TmForce (TmVar "e_recFib")) (TmVar "e_n")) "c_f1_6" (TmTo (TmApp (TmForce (TmVar "c_f1_6")) (TmVar "c_a1_6")) "c_f2_6" (TmTo (TmApp (TmForce (TmVar "c_f2_6")) (TmVar "e_y")) "c_f3_6" (TmPrintInt (TmVar "e_l") (TmPrintInt (TmVar "e_x") (TmApp (TmForce (TmVar "c_f3_6")) (TmVar "c_a3_6")))))))))))))))))))))) (TmForce (TmVar "c_r_7"))))) */
...
{
/* TmLam (Param {paramName = "e_n", paramType = TpInt}) (TmTo (TmApp (TmForce (TmGlobal "e_recFib")) (TmVar "e_n")) "c_f1_8" (TmTo (TmApp (TmForce (TmVar "c_f1_8")) (TmInt 0)) "c_f2_8" (TmTo (TmApp (TmForce (TmVar "c_f2_8")) (TmInt 0)) "c_f3_8" (TmApp (TmForce (TmVar "c_f3_8")) (TmInt 1))))) */
const item var_e_n = (global_stack.items[--global_stack.top]);
(global_stack.items[global_stack.top++]) = var_e_n;
const item sys_t_19 = top_e_recFib;
...
{
/* TmReturn (TmThunk (TmLam (Param {paramName = "e_n", paramType = TpInt}) (TmTo (TmApp (TmForce (TmGlobal "e_recFib")) (TmVar "e_n")) "c_f1_8" (TmTo (TmApp (TmForce (TmVar "c_f1_8")) (TmInt 0)) "c_f2_8" (TmTo (TmApp (TmForce (TmVar "c_f2_8")) (TmInt 0)) "c_f3_8" (TmApp (TmForce (TmVar "c_f3_8")) (TmInt 1))))))) */
...
{
/* TmApp (TmForce (TmGlobal "e_fib")) (TmInt 10) */
(global_stack.items[global_stack.top++]).int_item = 10;
const item sys_t_26 = top_e_fib;
