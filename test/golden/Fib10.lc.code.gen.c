...
void sys_thunk_15(item *const env, item *const ret)
{
/* TmTo (TmPrimBinOp PrimILt (TmVar "e_n") (TmVar "e_l")) "c_c_1" (TmLam (Param {paramName = "e_y", paramType = TpInt}) (TmLet "c_f0_6" (TmThunk (TmLam (Param {paramName = "aa_0_0", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "aa_1_0", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "aa_2_0", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "aa_3_0", paramType = TpInt}) (TmApp (TmApp (TmApp (TmApp (TmForce (TmVar "e_recFib")) (TmVar "aa_0_0")) (TmVar "aa_1_0")) (TmVar "aa_2_0")) (TmVar "aa_3_0"))))))))))))) (TmIf (TmVar "c_c_1") (TmReturn (TmInt 0)) (TmTo (TmPrimBinOp PrimIAdd (TmVar "e_l") (TmInt 1)) "c_a1_6" (TmTo (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmVar "e_y")) "c_a3_6" (TmTo (TmApp (TmForce (TmVar "c_f0_6")) (TmVar "e_n")) "c_f1_6" (TmTo (TmApp (TmForce (TmVar "c_f1_6")) (TmVar "c_a1_6")) "c_f2_6" (TmTo (TmApp (TmForce (TmVar "c_f2_6")) (TmVar "e_y")) "c_f3_6" (TmPrintInt (TmVar "e_l") (TmPrintInt (TmVar "e_x") (TmApp (TmForce (TmVar "c_f3_6")) (TmVar "c_a3_6")))))))))))) */
...
const item var_c_f0_6 = {.thunk_item = {.code = sys_thunk_5, .env = (item *) malloc(1 * sizeof(item))}};
...
void sys_thunk_16(item *const env, item *const ret)
{
/* TmLam (Param {paramName = "e_x", paramType = TpInt}) (TmReturn (TmThunk (TmTo (TmPrimBinOp PrimILt (TmVar "e_n") (TmVar "e_l")) "c_c_1" (TmLam (Param {paramName = "e_y", paramType = TpInt}) (TmLet "c_f0_6" (TmThunk (TmLam (Param {paramName = "aa_0_0", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "aa_1_0", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "aa_2_0", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "aa_3_0", paramType = TpInt}) (TmApp (TmApp (TmApp (TmApp (TmForce (TmVar "e_recFib")) (TmVar "aa_0_0")) (TmVar "aa_1_0")) (TmVar "aa_2_0")) (TmVar "aa_3_0"))))))))))))) (TmIf (TmVar "c_c_1") (TmReturn (TmInt 0)) (TmTo (TmPrimBinOp PrimIAdd (TmVar "e_l") (TmInt 1)) "c_a1_6" (TmTo (TmPrimBinOp PrimIAdd (TmVar "e_x") (TmVar "e_y")) "c_a3_6" (TmTo (TmApp (TmForce (TmVar "c_f0_6")) (TmVar "e_n")) "c_f1_6" (TmTo (TmApp (TmForce (TmVar "c_f1_6")) (TmVar "c_a1_6")) "c_f2_6" (TmTo (TmApp (TmForce (TmVar "c_f2_6")) (TmVar "e_y")) "c_f3_6" (TmPrintInt (TmVar "e_l") (TmPrintInt (TmVar "e_x") (TmApp (TmForce (TmVar "c_f3_6")) (TmVar "c_a3_6"))))))))))))))) */
...
{
/* TmLam (Param {paramName = "e_n", paramType = TpInt}) (TmLet "c_f0_8" (TmThunk (TmLam (Param {paramName = "aa_0_0", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "aa_1_0", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "aa_2_0", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "aa_3_0", paramType = TpInt}) (TmApp (TmApp (TmApp (TmApp (TmForce (TmGlobal "e_recFib")) (TmVar "aa_0_0")) (TmVar "aa_1_0")) (TmVar "aa_2_0")) (TmVar "aa_3_0"))))))))))))) (TmTo (TmApp (TmForce (TmVar "c_f0_8")) (TmVar "e_n")) "c_f1_8" (TmTo (TmApp (TmForce (TmVar "c_f1_8")) (TmInt 0)) "c_f2_8" (TmTo (TmApp (TmForce (TmVar "c_f2_8")) (TmInt 0)) "c_f3_8" (TmApp (TmForce (TmVar "c_f3_8")) (TmInt 1)))))) */
const item var_e_n = (global_stack.items[--global_stack.top]);
...
{
/* TmLet "aa_0_0_temp" (TmThunk (TmLam (Param {paramName = "e_n", paramType = TpInt}) (TmLet "c_f0_8" (TmThunk (TmLam (Param {paramName = "aa_0_0", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "aa_1_0", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "aa_2_0", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "aa_3_0", paramType = TpInt}) (TmApp (TmApp (TmApp (TmApp (TmForce (TmGlobal "e_recFib")) (TmVar "aa_0_0")) (TmVar "aa_1_0")) (TmVar "aa_2_0")) (TmVar "aa_3_0"))))))))))))) (TmTo (TmApp (TmForce (TmVar "c_f0_8")) (TmVar "e_n")) "c_f1_8" (TmTo (TmApp (TmForce (TmVar "c_f1_8")) (TmInt 0)) "c_f2_8" (TmTo (TmApp (TmForce (TmVar "c_f2_8")) (TmInt 0)) "c_f3_8" (TmApp (TmForce (TmVar "c_f3_8")) (TmInt 1)))))))) (TmLam (Param {paramName = "aa_0_0", paramType = TpInt}) (TmApp (TmForce (TmVar "aa_0_0_temp")) (TmVar "aa_0_0"))) */
...
{
/* TmReturn (TmThunk (TmLet "aa_0_0_temp" (TmThunk (TmLam (Param {paramName = "e_n", paramType = TpInt}) (TmLet "c_f0_8" (TmThunk (TmLam (Param {paramName = "aa_0_0", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "aa_1_0", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "aa_2_0", paramType = TpInt}) (TmReturn (TmThunk (TmLam (Param {paramName = "aa_3_0", paramType = TpInt}) (TmApp (TmApp (TmApp (TmApp (TmForce (TmGlobal "e_recFib")) (TmVar "aa_0_0")) (TmVar "aa_1_0")) (TmVar "aa_2_0")) (TmVar "aa_3_0"))))))))))))) (TmTo (TmApp (TmForce (TmVar "c_f0_8")) (TmVar "e_n")) "c_f1_8" (TmTo (TmApp (TmForce (TmVar "c_f1_8")) (TmInt 0)) "c_f2_8" (TmTo (TmApp (TmForce (TmVar "c_f2_8")) (TmInt 0)) "c_f3_8" (TmApp (TmForce (TmVar "c_f3_8")) (TmInt 1)))))))) (TmLam (Param {paramName = "aa_0_0", paramType = TpInt}) (TmApp (TmForce (TmVar "aa_0_0_temp")) (TmVar "aa_0_0"))))) */
